...
"      \ 'v' : ['<plug>(VimspectorAddFunctionBreakpoint)'                              , 'function break'],
...
let g:which_key_map.z = {
      \ 'name' : '+vimspector' ,
      \ 'd' : ['vimspector#Continue()'                              , 'continue'],
      \ 's' : ['vimspector#Stop()'                              , 'stop'],
      \ 'r' : ['vimspector#Restart()'                              , 'restart'],
      \ 'p' : ['vimspector#Pause()'                              , 'pause'],
      \ 'b' : ['vimspector#ToggleBreakpoint()'                              , 'breakpoint'],
      \ 'v' : ['vimspector#AddFunctionBreakpoint(<cexpr>)'                              , 'function break'],
